...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getLibraryControllerService()
    {
        ...
        return $this->services['App\\Controller\\LibraryController'] = new \App\Controller\LibraryController();
    }
    ...
    protected function getApp_BookManagerService()
    {
        ...
        return $this->services['app.book_manager'] = new \App\Manager\BookManager(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
